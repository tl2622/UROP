...
for n in range(0, M-1):
    ...
    if n % 10 == 0:
        ...
        plt.ylabel('u(x)')
        plt.ylim(-1.5, 1.5) 
        plt.title('Stochastic Burgers Equation with Transport Noise --- affine case')
        plt.legend()
...
clip.write_videofile("stochastic_burgers_transport_noise_affine.mp4", codec="libx264")
